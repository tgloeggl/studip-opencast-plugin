        ...
        jQuery('.oce_item').click(function(e){
            ...
            jQuery.get(STUDIP.ABSOLUTE_URI_STUDIP + "plugins.php/opencast/course/get_player/" +  episode_id + "/" +  cid).done(function(data) {
                ...
                */
                ...
                var preview = _.template(preview_template);
                var x = preview({episode:episode, theodul:data.theodul, embed:data.embed,dozent:dozent,engage_player_url:data.engage_player_url, previmage:previmage});

                jQuery('.oce_playercontainer').empty();
                //jQuery('.oce_playercontainer').html(player);
                jQuery('.oce_playercontainer').html(x);
